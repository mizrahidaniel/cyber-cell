...
|------|------|----------|-----------|-----------|-----------------|--------|
| 1 | 6 | tree | 0.934 | 0.67 | up | (145, 121) |
| 2 | 4 | star | 0.727 | 0.75 | up | (222, 369) |
| 3 | 3 | ring | 0.750 | 0.67 | right | (226, 356) |
| 4 | 2 | pair | 1.000 | 1.00 | up | (21, 360) |
| 5 | 2 | pair | 1.000 | 1.00 | up | (23, 360) |
| 6 | 2 | pair | 1.000 | 1.00 | up | (490, 36) |
| 7 | 2 | pair | 1.000 | 0.50 | right | (272, 257) |
| 8 | 2 | pair | 1.000 | 0.50 | down | (202, 312) |
| 9 | 2 | pair | 1.000 | 0.50 | right | (21, 362) |
| 10 | 2 | pair | 1.000 | 0.50 | right | (410, 452) |
| 11 | 2 | pair | 1.000 | 1.00 | right | (406, 218) |
...
| tree | 1 | Branching structure, no loops |
| star | 1 | One hub cell bonded to many leaves |
| ring | 1 | Circular bond chain |

## Facing Coordination

Of 3 clusters with 3+ cells, **3** (100%) show coordinated facing (>50% cells face same direction).
...
- 9/34 (26%) are stationary (moved < 5 cells)
- Average movement: 114.6 cells per 10K ticks
- Max movement: 465.3 cells

## Genome Diversity Within Clusters

- 3/3 clusters have ALL unique genomes (every cell is a distinct mutant)
...
- Bonded cells avg X: 211.2
- Unbonded cells avg X: 259.3
