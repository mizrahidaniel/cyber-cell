...
This simulation run achieved: **chemotaxis (27% of cells moving)**.
...
| Minimum (bottleneck) | 157 (tick 49,000) |
| Final population | 157 |
| Growth rate | 0.0% per 1K ticks (post-bottleneck) |
...
| Post-crash movement | 27.4% (non-movers survive) |
| Final movement | 27.4% |
...
2. **Crash phase**: Movement drops to ~27% — stationary photosynthesizers survive the bottleneck
3. **Evolution phase**: Movement rises to 27% — but this time it is *directed*, not random
...
Cells began clustered in the light zone (x < 166) and expanded into the **light zone** (avg x = 105.5). This spatial expansion indicates cells evolved the ability to survive outside the primary energy source, using chemical deposits for sustenance.
...
| Final Shannon index | 5.056 |
| Final unique genomes | 157 |
| Dominant genome fraction | 0.6369% |

Shannon diversity *increased* over the run, indicating the evolution of multiple coexisting strategies rather than a single dominant genome. The dominant genome accounts for only 0.6369% of the population — extreme diversity.
...
| Final avg energy | 15.0 |
| Final avg repmat | 167.7 |
| Max observed age | 1,229 ticks |

Energy accumulation shows cells evolved increasingly efficient metabolic strategies. The max observed age of 1,229 ticks (0x the nominal max age of 5,000) indicates lineages with exceptional survival ability.

### 6. Environmental Pressure

| Metric | Value |
|--------|-------|
| Avg waste at cells | 0.3493 |
| Peak waste | 0.5613 |
| Cells above toxicity | 73.9% |
| Bright zone | 98.7% |
| Dim zone | 0.0% |
| Dark zone | 1.3% |
...
|-------|-----------|-------------|
| Crash | 0 – 49,000 | Population drops from 2000 to 157 (92% mortality) |
| Chemotaxis Emergence | 2,000 – 49,000 | Movement fraction exceeds 15% at tick 2000, reaches 27.4% by end |
| Predation Emergence | 17,000 – 49,000 | Attack fraction exceeds 1% at tick 17000, reaches 2.5% by end |
| Waste Pressure | 2,000 – 49,000 | >5% of cells above toxicity threshold from tick 2000, peak 88.5% |
| Bonding Emergence | 2,000 – 49,000 | Bond fraction exceeds 1% at tick 2000, reaches 9.6% by end |
