...
| Minimum (bottleneck) | 50 (tick 167,000) |
...
| Final avg X | 91.0 |
| Expansion rate | -0.6 units per 1K ticks |

Cells began clustered in the light zone (x < 166) and expanded into the **light zone** (avg x = 91.0). This spatial expansion indicates cells evolved the ability to survive outside the primary energy source, using chemical deposits for sustenance.
...
| Final Shannon index | 4.981 |
| Final unique genomes | 146 |
| Dominant genome fraction | 1.3605% |

Shannon diversity *increased* over the run, indicating the evolution of multiple coexisting strategies rather than a single dominant genome. The dominant genome accounts for only 1.3605% of the population — extreme diversity.
...
| Final avg energy | 64.6 |
| Final avg repmat | 11.6 |
| Max observed age | 5,071 ticks |

Energy accumulation shows cells evolved increasingly efficient metabolic strategies. The max observed age of 5,071 ticks (1x the nominal max age of 5,000) indicates lineages with exceptional survival ability.

## Evolutionary Phases Detected

| Phase | Tick Range | Description |
|-------|-----------|-------------|
| Crash | 0 – 167,000 | Population drops from 1015 to 50 (95% mortality) |
| Expansion | 167,000 – 168,000 | Population doubles to 154 |
| Bonding Emergence | 2,000 – 199,000 | Bond fraction exceeds 1% at tick 2000, reaches 1.4% by end |
